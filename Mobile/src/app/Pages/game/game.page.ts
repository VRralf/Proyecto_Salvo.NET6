...
export class GamePage implements OnInit {
    ...
    getGameData() {
        ...
        this.gameState = this.getGameState(this.gameView.gameState);
        if (this.gameView.gameState != 'WIN' || this.gameView.gameState != 'TIE' || this.gameView.gameState != 'LOSS') {
